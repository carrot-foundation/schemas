...
when_to_use:
  - 'After modifying Zod schemas that affect JSON output'
  - 'After adding new schema types'
  - 'When example files are stale or missing'
...
workflow:
  ...
  - '[ ] Run pnpm verify-schema-versions'
  - '[ ] Run pnpm check-refs'
...
outputs:
  - 'Updated JSON schemas, examples, and hashes in schemas/ipfs/'
references:
  - .ai/rules/json-schema.md
  - .ai/rules/schema-versioning.md
---
