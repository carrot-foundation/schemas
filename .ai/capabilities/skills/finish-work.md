...
when_to_use:
  ...
  - 'When the user says they are done and want to wrap up'
  - 'End of a development session with uncommitted work'
workflow:
  - '[ ] Validate branch naming'
  - '[ ] Run pnpm check (all quality gates)'
  - '[ ] Stage and commit changes via commit skill'
  - '[ ] Create PR via create-pr skill'
  - '[ ] Summarize what was done'
inputs:
  - 'Completed work on a feature branch'
outputs:
  - 'All checks passing, committed changes, created PR'
references:
  - .ai/capabilities/skills/check.md
  - .ai/capabilities/skills/commit.md
  - .ai/capabilities/skills/create-pr.md
---
