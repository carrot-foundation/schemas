...
when_to_use:
  - 'Creating new Zod schemas'
  - 'Modifying existing schemas'
  - 'Adding fields or validation rules'
  - 'When unsure about Zod patterns for this project'
workflow:
  - '[ ] Define schema using z.strictObject()'
  - '[ ] Add .meta() to every field'
  - '[ ] Compose via .safeExtend() if extending'
...
inputs:
  ...
  - 'Field definitions'
outputs:
  - 'Zod schema following project conventions'
references:
  - .ai/rules/zod.md
