...
intent: 'Naming standards — snake_case properties, kebab-case files, PascalCase types and exports'
scope:
  - 'src/**/*.ts'
requirements:
  - 'snake_case for all schema property names'
  - 'kebab-case for file and directory names'
  - 'PascalCase for schema exports (`[Entity]Schema`) and type exports (`[Entity]`)'
  - '_id suffix for ID fields'
  - 'Include unit in measurement names (e.g., `distance_km`)'
  - '_code suffix for code fields'
anti_patterns:
  - 'camelCase in schema properties'
  - 'PascalCase file names'
  - '`Schema` suffix on type exports'
  - 'Inconsistent casing across related schemas'
