---
id: code-comments
intent: 'When and how to write effective comments — favor self-documenting code'
scope:
  - 'src/**/*.ts'
requirements:
  - 'Favor self-documenting code over comments'
  - 'Explain WHY not WHAT'
  - 'Document domain/business context and non-obvious constraints'
  - 'Use TSDoc sparingly for exported symbols'
  - 'Delete stale comments immediately'
anti_patterns:
  - 'Obvious comments that restate code'
  - 'Commented-out code left in'
  - 'TODO comments without context or owner'
  - 'JSDoc on every function regardless of clarity'
---
