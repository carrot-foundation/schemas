...
- [ ] Fill required sections per `@pull-request-description.mdc`
...
- `@pull-request.mdc` - Core PR rules and analysis
- `@pull-request-description.mdc` - Description standards
- `.github/pull_request_template.md` - Template structure
