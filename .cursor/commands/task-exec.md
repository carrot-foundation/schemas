...
- **TypeScript/JavaScript**: Follow `@code-comments.mdc` – explain domain context or non-obvious constraints, not implementation details.
...
- `@clickup-task.mdc` - Task standards

**TypeScript/JavaScript:**

- `@code-comments.mdc` - Comment guidelines

**General:**

- `@commit.mdc` - Commit conventions
